...
const projects = [
  {
    ...
    stack: ["Laravel 13", "Filament v5", "PostgreSQL", "MikroTik RouterOS API", "FreeRADIUS"],
    links: [
      { href: "https://nexalink.app", label: "Live App", icon: ExternalLink },
      { href: "https://github.com/Developerzon12", label: "GitHub", icon: Github },
    ],
  },
  {
    title: "mikrotik-laravel – Open Source Package",
    desc: "Published Laravel package for MikroTik RouterOS API integration. Available on Packagist. PR #142 merged into routeros-api-php upstream.",
    stack: ["PHP", "Laravel", "Packagist", "Open Source", "MikroTik API"],
    links: [
      {
        href: "https://github.com/Zilleali/mikrotik-laravel",
        label: "GitHub",
        icon: Github,
      },
      {
        href: "https://packagist.org/packages/zilleali/mikrotik-laravel",
        label: "Packagist",
        icon: Package,
      },
    ],
              ...
              <div className="mt-7 flex flex-wrap items-center gap-4">
                {p.links.map((link) => (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-sm text-[#F5F5F5] hover:text-[#E8521A] transition-colors"
                  >
                    <link.icon size={15} />
                    {link.label}
                  </a>
